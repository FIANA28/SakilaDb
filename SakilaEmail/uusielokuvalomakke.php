  ...
  // inserting data from checkbox
    ...
    // }
            ...
            if($result == TRUE) {    
              ...
              echo "<span class='success'><br><b>Elokuva lisätty tietokantaan</span>";
...
<!-- Navbar End -->
    <div class="container">
        ...
        <form style="border: 1px solid green; padding:40px 20px 40px 40px;" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
